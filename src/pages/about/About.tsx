...
const About = () => {
  return (
    <div className="m-10 mb-5 pb-5 about">
      <h1 className="w-full mt-10 md:mt-0 md:ml-0 ml-10 text-3xl font-bold text-[#6D625C]">
        Qui sommes-nous ?
      </h1>

      <div className="m-10 grid grid-cols-1 gap-16 lg:gap-28  lg:grid-cols-2 space-x- h-full bg-red p-0 mb-0   pb-5  ">
