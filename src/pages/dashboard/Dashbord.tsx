...
import DashboardHero from '../../components/hero/dashbordHero/DashboardHero';
...
const Dashboard = (props: { updateIsAdmin: (value: boolean) => void }) => {
  ...
  return (
    <div className="containerDashboard w-11/12 lg:w-9/12 mx-auto md:block mb-5 ">
      <DashboardHero />
      {showModification ? (
        <Modification
      ...
      <Form className="grid grid-cols-1 md:grid-cols-4 gap-4 px-3">
        ...
        <Form.Group as={Col} controlId="formType">
          <Form.Label className="block text-[#6D625C] text-lg text-bold">
            Type de service
          </Form.Label>
          <Form.Control
            as="select"
        ...
        <Form.Group as={Col} controlId="formButton" style={{ color: 'black' }}>
          <Form.Label className="block text-[#6D625C] text-lg text-bold invisible">
            Envoyer
          </Form.Label>
          <Button
